...
public class GridGenerator : MonoBehaviour
{
    ...
    void CreateBuffers()
    {
        ...
        if (!Application.isPlaying || (pointsBuffer == null || numPoints != pointsBuffer.count))
        {
            ...
            terraformBuffer = new ComputeBuffer(numPoints, sizeof(float) * 1);
    ...
    private void Run()
    {
        ...
        if (clicked)
        {
            ...
            if (didHit)
            {
                ...
                terraformShader.SetBuffer(0, "offsets", terraformBuffer);
                terraformShader.SetInt("numPointsPerAxis", numPointsPerAxis);
                terraformShader.SetFloat("boundsSize", boundsSize);
                terraformShader.SetInts("brushCentre", id.x, id.y, id.z);
                terraformShader.SetFloat("spacing", pointSpacing);
        ...
        CubeMarcher.SetBuffer(0, "offsets", terraformBuffer);
